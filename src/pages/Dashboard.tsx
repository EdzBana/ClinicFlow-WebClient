...
interface CategoryData {
  category: string; // reused for item name
  count: number;
}
...
// Distinct colors for bar chart categories
const BAR_COLORS = [
  "#680000",
  "#1e40af",
  "#15803d",
  ...
  useEffect(() => {
    const fetchDispenseData = async () => {
      ...
      try {
        ...
        // --- Category breakdown (within selected time range) ---
